  ...
  bot.start(async (ctx) => {
    ...
    try {
      ...
      const welcomeText =
        ...
        'Я могу:\n\n' +
        'Сделать вам фотосессию на основе готовых шаблонов\n\n' +
        'Изменить фотографию или сгенерировать картинку по вашей просьбе\n' +
        '— например загрузи фото и напиши: замени фон, улучши качество\n\n' +
        'Научить работать с промтами\n\n' +
